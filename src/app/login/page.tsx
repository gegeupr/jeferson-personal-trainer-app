...
function LoginInner() {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const successMsg =
        role === "professor"
          ? "Conta criada! Confirme seu e-mail para começar o teste grátis de 7 dias."
        ...
        <div className="text-center">
          ...
          {profFromUrl && (
            <p className="mt-2 text-sm text-white/70">
              ...
              <span className="text-white font-semibold">Motion</span>.
            </p>
          )}
        </div>
...
export default function LoginPage() {
  return (
    <Suspense
      fallback={
        <main className="min-h-screen bg-[#0a0a0a] flex items-center justify-center text-white text-xl">
          Carregando…
        </main>
      }
    >
